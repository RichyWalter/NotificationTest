...
class NotificationHelper extends ContextWrapper {
    ...
    public static final String CHANNEL_ONE_ID = "de.richardwalter.notificationchannels.ONE";
    public static final String CHANNEL_ONE_NAME = "Channel One";
    public static final String CHANNEL_TWO_ID = "de.richardwalter.notificationchannels.TWO";
...
//Create the notification that’ll be posted to Channel One//
    ...
    public Notification.Builder getNotification1(String title, String body) {
        return new Notification.Builder(getApplicationContext(), CHANNEL_ONE_ID)
                ...
                .setContentText(body)
                .setSmallIcon(R.drawable.error_triangle)
                .setAutoCancel(true);
    }
...
//Create the notification that’ll be posted to Channel Two//
    ...
    public Notification.Builder getNotification2(String title, String body) {
        return new Notification.Builder(getApplicationContext(), CHANNEL_TWO_ID)
                .setContentTitle(title)
                .setContentText(body)
                .setSmallIcon(R.drawable.error_circle)
                .setAutoCancel(true);
    }
